...
public class MainActivityGrid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bacadata();
        MainActivityGridAdapter appAdapter=new MainActivityGridAdapter(menuArrayList,this);
        recyclerView.setAdapter(appAdapter);

        recyclerView.setLayoutManager(new GridLayoutManager(MainActivityGrid.this, 2));
    }
