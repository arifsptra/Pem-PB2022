...
public class MainActivityListAdapter extends RecyclerView.Adapter<MainActivityListAdapter.myViewHolder>{
    ArrayList<modelApp> arrayList;
    Context context;

    public MainActivityListAdapter(ArrayList<modelApp> arrayList, Context context){
        this.arrayList = arrayList;
        this.context = context;
    }

    @Override
    public MainActivityListAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(context);
        View view=inflater.inflate(R.layout.activity_main_list_view, parent, false);
        return new MainActivityListAdapter.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MainActivityListAdapter.myViewHolder holder, @SuppressLint("RecyclerView") final int position) {
